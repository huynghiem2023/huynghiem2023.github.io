...
(function() {
  ...
  function makeMove(moveCode, callback) {
    ...
    // Animate wrapper (slowed down to 2s for very clear tutorial step tracing)
    wrapper.style.transition = 'transform 2s cubic-bezier(0.25, 1, 0.5, 1)';
    // Force reflow
    ...
    }, 3000); // 3 seconds total per move (2s animation + 1s pause)
  }
