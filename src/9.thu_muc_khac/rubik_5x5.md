  ...
  <div class="cube-workspace">
    ...
    <div class="cube-right-panel">
      ...
      <div class="tab-content hidden" id="tab-patterns">
        ...
        <div class="step-guide">
          <strong>13. Hoa văn Bàn cờ ba lớp (Tri-Checkerboard)</strong>
          <p>Tạo hiệu ứng bàn cờ xen kẽ 3 lớp phức tạp và tinh xảo vô cùng trên cả 6 mặt khối 5x5.</p>
          <div class="formula-box">Công thức: <span class="formula">F B2 R' D2 B R U D' R L' D' F' R2 D F2 B' + Fw Bw2 Rw' Dw' Bw Rw Uw Dw' Rw Lw' Dw' Fw' Rw2 Dw Fw2 Bw'</span></div>
          <button class="btn btn-success play-algo-pattern" data-algo="F B B R' D D B R U D' R L' D' F' R R D F F B' f b b r' d' b r u d' r l' d' f' r r d f f b'">Tạo hoa văn Bàn cờ ba lớp</button>
        </div>

        <div class="step-guide">
          <strong>14. Hoa văn Nhụy hoa kép (Dot in a Dot)</strong>
          <p>Tạo hiệu ứng tâm hoa hai lớp màu lồng nhau tuyệt đẹp ở chính giữa các mặt.</p>
          <div class="formula-box">Công thức: <span class="formula">U D' R L' F B' U D' + Uw Dw' Rw Lw' Fw Bw' Uw Dw'</span></div>
          <button class="btn btn-success play-algo-pattern" data-algo="U D' R L' F B' U D' u d' r l' f b' u d'">Tạo hoa văn Nhụy hoa kép</button>
        </div>

        <div class="step-guide">
          <strong>15. Hoa văn Nhụy hoa tâm chéo (Dot in a Crosshair)</strong>
          <p>Thiết kế hồng tâm chấm tròn nhỏ được bao quanh bởi một khung ngắm chữ thập kép siêu độc đáo.</p>
          <div class="formula-box">Công thức: <span class="formula">(Dot in a Dot) + Lw2 Rw2 Uw2 Dw2 Bw2 Fw2</span></div>
          <button class="btn btn-success play-algo-pattern" data-algo="U D' R L' F B' U D' u d' r l' f b' u d' l l r r u u d d b b f f">Tạo hoa văn Nhụy hoa tâm chéo</button>
        </div>

        <div class="step-guide">
          <strong>16. Hoa văn Bàn cờ đôi (Double Checkerboard)</strong>
          <p>Hiệu ứng bàn cờ đan xen kép tạo hai khung lưới màu lồng ghép tương tác sinh động.</p>
          <div class="formula-box">Công thức: <span class="formula">U D' R L' F B' U D' + Lw2 Rw2 Uw2 Dw2 Bw2 Fw2 + L2 R2 F2 B2 D2 U2</span></div>
          <button class="btn btn-success play-algo-pattern" data-algo="U D' R L' F B' U D' l l r r u u d d b b f f L L R R F F B B D D U U">Tạo hoa văn Bàn cờ đôi</button>
        </div>

        <div class="step-guide">
          <strong>17. Hoa văn Lật cạnh viền ngoài (Flipped Edges)</strong>
          <p>Lật ngược toàn bộ chiều màu của 12 cụm viên cạnh ngoài cùng mà không làm đổi vị trí các viên góc hay tâm.</p>
          <div class="formula-box">Công thức: <span class="formula">F B2 R' D2 B R U D' R L' D' F' R2 D F2 B'</span></div>
          <button class="btn btn-success play-algo-pattern" data-algo="F B B R' D D B R U D' R L' D' F' R R D F F B'">Tạo hoa văn Lật cạnh viền ngoài</button>
        </div>

        <div class="step-guide">
          <strong>18. Bốn nhụy hoa hông (Four Side Dots)</strong>
          <p>Chỉ hoán đổi 4 chấm nhụy hoa ở các mặt bên hông khối Rubik, giữ cho 2 mặt đáy và đỉnh được sạch hoàn toàn.</p>
          <div class="formula-box">Công thức: <span class="formula">Lw Rw' Uw Dw' Lw' Rw Uw' Dw</span> (sử dụng lát đôi)</div>
          <button class="btn btn-success play-algo-pattern" data-algo="l r' u d' l' r u' d">Tạo hoa văn Bốn nhụy hoa hông</button>
        </div>

        <div class="step-guide">
          <strong>19. Cột sọc dọc (Vertical Stripes)</strong>
          <p>Tạo các dải màu chạy dọc song song bao quanh toàn bộ các mặt khối Rubik.</p>
          <div class="formula-box">Công thức: <span class="formula">F2 R2 L2 B2 U2 D2</span></div>
          <button class="btn btn-success play-algo-pattern" data-algo="F F R R L L B B U U D D">Tạo hoa văn Cột sọc dọc</button>
        </div>

        <div class="step-guide">
          <strong>20. Vòng xoáy ốc (Spiral)</strong>
          <p>Tạo một vệt đường xoắn ốc tuyệt đẹp nối liền uốn quanh toàn bộ khối Rubik 5x5.</p>
          <div class="formula-box">Công thức: <span class="formula">L' B' D L F' R U' B' R2 D' F' L' U L D' R2</span></div>
          <button class="btn btn-success play-algo-pattern" data-algo="L' B' D L F' R U' B' R R D' F' L' U L D' R R">Tạo hoa văn Vòng xoáy ốc</button>
        </div>

        <div class="step-guide">
          <strong>21. Chữ thập viền ngoài (Side Crosses)</strong>
          <p>Tạo các chữ thập nhỏ viền màu tinh tế nằm ở các góc mặt bên cạnh của khối Rubik.</p>
          <div class="formula-box">Công thức: <span class="formula">R2 L2 U D' F2 B2 U D'</span></div>
          <button class="btn btn-success play-algo-pattern" data-algo="R R L L U D' F F B B U D'">Tạo hoa văn Chữ thập viền ngoài</button>
        </div>

        <div class="step-guide">
          <strong>22. Cột sọc đôi ở giữa (Double Middle Stripes)</strong>
          <p>Xoay các lát bên trong để tạo 2 vòng sọc đôi chạy song song quanh khối Rubik, giữ nguyên các góc mặt.</p>
          <div class="formula-box">Công thức: <span class="formula">Rw2 Lw2 Uw2 Dw2</span> (xoay các lớp đôi ở giữa)</div>
          <button class="btn btn-success play-algo-pattern" data-algo="r r l l u u d d">Tạo hoa văn Cột sọc đôi ở giữa</button>
        </div>
      </div>
    </div>
  </div>
