    ...
    <div class="cube-right-panel">
      ...
      <div class="tab-content hidden" id="tab-patterns">
        ...
        <div class="step-guide">
          ...
          <p>Tạo hình một chú rắn màu sắc uốn lượn xung quanh toàn bộ khối Rubik, một trong những hoa văn cổ điển rất bắt mắt.</p>
        ...
        <div class="step-guide">
          ...
          <p>Tương tự như Anaconda, tạo hoa văn đường vây uốn quanh giống như con trăn lớn, mang lại vẻ đẹp độc đáo và cân đối.</p>
        ...
        <div class="step-guide">
          <strong>10. Hoa văn Đỉnh kép 2x2 (2x2 Peak)</strong>
          <p>Tạo ra hai cụm 2x2 nhô lên như hai đỉnh núi đối xứng tuyệt đẹp ở hai góc chéo của Rubik 4x4x4. Đây là hoa văn rất đặc trưng cho dòng Rubik chẵn lớp.</p>
          <div class="formula-box">Công thức: <span class="formula">b2 d2 Lw2 U F2 L2 D' L' D L' F U' F Lw2 d2 b2</span></div>
          <button class="btn btn-success play-algo-pattern" data-algo="b2 d2 l2 U F F L L D' L' D L' F U' F l2 d2 b2">Tạo hoa văn Đỉnh kép 2x2</button>
        </div>

        <div class="step-guide">
          <strong>11. Hoa văn Đỉnh đôi xoắn (Twisted Peaks)</strong>
          <p>Tạo hai khối chóp đỉnh tam giác xoắn ngược cực kỳ độc đáo và nghệ thuật ở hai góc đối diện của khối Rubik.</p>
        ...
        <div class="step-guide">
          ...
          <p>Tạo hình chữ thập (dấu cộng "+") lớn đồng màu chiếm trọn tâm của mỗi mặt trên khối Rubik, làm nổi bật cấu trúc đối xứng.</p>
        ...
        <div class="step-guide">
          <strong>13. Hoa văn Hộp quà Giáng sinh (Gift Box)</strong>
          <p>Tạo hiệu ứng khối Rubik được thắt dây ruy-băng như một hộp quà xinh xắn đầy màu sắc từ mọi góc nhìn.</p>
        ...
        <div class="step-guide">
          <strong>14. Khối lồng khối 3 tầng song song (Triple Cube - Wide version)</strong>
          <p>Phiên bản lồng khối 3 tầng (2x2x2 lồng trong 3x3x3 lồng trong 4x4x4) cực kỳ gọn gàng và song song theo hướng xoay rộng, cho hiệu ứng chiều sâu 3D hoàn mỹ.</p>
          <div class="formula-box">Công thức: <span class="formula">Bw2 Rw' Dw Rw Dw' Rw' Dw Rw Uw Rw' Dw' Rw Dw Rw' Dw' Rw Uw' Bw2</span></div>
          <button class="btn btn-success play-algo-pattern" data-algo="b2 r' d r d' r' d r u r' d' r d r' d' r u' b2">Tạo hoa văn Khối lồng khối 3 tầng</button>
        </div>
      </div>
    </div>
  </div>
